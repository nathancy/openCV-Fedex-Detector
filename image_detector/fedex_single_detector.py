...
def boxesAdjacent(box1, box2, contour1, contour2, frame):
    ...
    cv2.circle(frame, (box1[4],box1[5]), 2, (255,255,255),2)
    cv2.circle(frame, (box2[4],box2[5]), 2, (255,255,255),2)
...
#frame = cv2.imread('dark-red.jpg')
#frame = cv2.imread('fedex-car.PNG')
#frame = cv2.imread('fedex-logo.PNG')
#frame = cv2.imread('fedex-tunnel.jpg')
#frame = cv2.imread('light-red.jpg')
...
if box1 and box2:
    boxesAdjacent(box1, box2, box1[6], box2[6], frame)
